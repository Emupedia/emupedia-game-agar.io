...
const STORAGE_KEY = "agar-ext-settings";
const BINDINGS_VERSION_KEY = "agar-ext-bindv";
const BINDINGS_VERSION = "4";
const CHAT_OP_FIX_KEY = "agar-ext-chatopfix";
const SPECTATOR_OFF_KEY = "agar-ext-specoff";
